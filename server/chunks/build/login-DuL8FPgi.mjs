import { v as vueExports, u as useHead, o as useToast, s as serverRenderer_cjs_prodExports, d as _sfc_main$d, a as __nuxt_component_0$3, f as _sfc_main$8, w as useRuntimeConfig, U as UserRequestUrl, P as PublicRequestUrl } from './server.mjs';
import { _ as _sfc_main$1 } from './Input-BoQpFAq3.mjs';
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (vueExports.unref(state).feature.step === "credentials") {
        ...
        _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_NuxtLink, { class: "text-xs text-sage-600 hover:text-sage-700 transition-colors" }, {
      ...
      _push(`<div class="flex items-center gap-3 my-6"><div class="flex-1 h-px bg-sand-200"></div><span class="text-xs text-sand-400">或</span><div class="flex-1 h-px bg-sand-200"></div></div><p class="text-center text-sm text-sand-500"> 還沒有帳號？ `);
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_NuxtLink, { class: "text-sage-600 font-medium hover:text-sage-700 transition-colors" }, {
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` 立即註冊 `);
          } else {
            return [
              vueExports.createTextVNode(" 立即註冊 ")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=login-DuL8FPgi.mjs.map
