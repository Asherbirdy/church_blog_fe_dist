...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "min-h-screen bg-sand-50" }, _attrs))}> /* eslint-disable-next-line vue/no-v-html */ `);
...
//# sourceMappingURL=_routeName_-BPUY8ga4.mjs.map
