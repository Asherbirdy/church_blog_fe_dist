import { v as vueExports, p as pinia_prodExports, s as serverRenderer_cjs_prodExports, d as _sfc_main$d, e as __nuxt_component_2, f as _sfc_main$8 } from './server.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!vueExports.unref(state).feature.isEditing) {
        ...
        _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_UInput, {
          modelValue: vueExports.unref(editForm).name,
          "onUpdate:modelValue": ($event) => vueExports.unref(editForm).name = $event,
          icon: "i-lucide-user",
          size: "lg",
          ui: { base: "rounded-xl" }
        }, null, _parent));
      ...
      if (!vueExports.unref(state).feature.isEditing) {
        ...
        _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_UInput, {
          modelValue: vueExports.unref(editForm).email,
          "onUpdate:modelValue": ($event) => vueExports.unref(editForm).email = $event,
          type: "email",
          icon: "i-lucide-mail",
          size: "lg",
          ui: { base: "rounded-xl" }
...
//# sourceMappingURL=home-CvBqLOBW.mjs.map
