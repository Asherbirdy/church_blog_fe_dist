...
import { a as _sfc_main$4 } from './TiptapEditor-zv2nBLfK.mjs';
...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div></div><div class="w-full lg:w-[380px] shrink-0 animate-fade-up stagger-3 lg:sticky lg:top-6 lg:self-start">`);
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(_sfc_main$4), null, null, _parent));
      _push(`</div></div></div>`);
    };
  }
});
...
//# sourceMappingURL=index-QdAiylei.mjs.map
