import { v as vueExports, u as useHead, A as useSeoMeta, s as serverRenderer_cjs_prodExports, a as __nuxt_component_0$3, d as _sfc_main$d } from './server.mjs';
  ...
  setup(__props) {
    useHead({
      ...
      link: [
        ...
        { rel: "stylesheet", href: "/chatbot/chatbot.css" }
      ],
      script: [
        {
          src: "/chatbot/index.min.js",
          onload: () => (void 0).Chatbot?.init()
        }
      ],
      htmlAttrs: {
        lang: "zh-TW"
...
//# sourceMappingURL=default-D_2bE-7V.mjs.map
